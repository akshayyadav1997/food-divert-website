...
textarea {
  ...
  <body>
     ...
     <!--  <div class="navbar navbar-default navbar-fixed-top navbar-inverse" >
       ...
       <div class="navbar navbar-default navbar-fixed-top navbar-inverse" >
          ...
          <span class="icon-bar"></span>
             ...
             <a href="../main.htm" ><b>HOME</b></a>
                    ...
                    <li class="dropdown">
                    <a href="../donor.htm"><b>DONORS</b><b></b></a>
                   ...
                   <!-- <ul class="dropdown-menu">
                    ...
                    <li class="dropdown">
                    <a href="donation_tab.php"><b>STATUS</b><b></b></a>
       ...
       <br>
      <div>
      <center><h1><font color="white">DONOR AND RECEIVER STATUS</font></h1></center>
      </div>
      ...
      <!--<div class="container">
    <center><label><b><font color="white"><h3>Name:&nbsp;&nbsp;</h3></font></b></label>
    <input type="text" id="user" placeholder="Name" name="user" required><br></center><br>

    <center><label><b><font color="white"><h3>&nbsp;&nbsp;Contact:&nbsp;</h3></font></b></label>
    <input type="Contact" id="pass" placeholder="Contact" name="pass" required></center><br>

    <center><label><b><font color="white"><h3>&nbsp;&nbsp;Address:</h3></font></b></label> 
    <textarea cols="10" rows="1" placeholder="Enter Address"></textarea><br></center><br>

    <center><label><b><font color="white"><h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Food Name:</h3></font></b></label>
    <input type="text" id="user" placeholder="Food Name" name="user" required><br></center><br>

    <center><label><b><font color="white"><h3>&nbsp;&nbsp;Quantity:</h3></font></b></label>
    <input type="text" id="user" placeholder="Quantity In Plates" name="user" required><br></center><br>

    <center><label><b><font color="white"><h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Best Before:</h3></font></b></label>
    <input type="date" id="user" placeholder="Best Befor(DATE)" name="user" required><br></center><br>

    <center><label><b><font color="white"><h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nearest Station:</h3></font></b></label>
    <input type="text" id="user" placeholder="Nearest Railway Station" name="user" required><br></center><br>

    <center><b><font color="white"><h3>Type:</h3></font></b>
    <input type="Radio" name="Type"><font color="white"><h3>Veg</h3></font>
        <input type="Radio" name="Type"><font color="white"><h3>Non-Veg</h3></font><br></center><br>


    <!-- <center><label><b>&nbsp;&nbsp;Confirm</b></label>
    <input type="password" id="pass" placeholder="Confirm Password" name="cpass" required></center>-->

    <!-- <center><p><button name="submit_btn" type="submit" id="btn" value="Sign Up">Add Image</button></p></center><br>
        
    <center><p><button name="submit_btn" type="submit" id="btn" value="Sign Up">Done</button></p></center>
    <!--<input type="checkbox" checked="checked"> Remember me-->

  <center><table width="600" border="1" cellpadding="10" cellspacing="10">
...
$sql = "SELECT * FROM testing1";
$records = mysql_query($sql);


 while ($donate = mysql_fetch_assoc($records)) {
      echo "<tr>";

      echo "<td>".$donate['donorname']."</td>" ;

      echo "<td>".$donate['receivername']."</td>";

      echo "<td>".$donate['status']."</td>";
      ...
      echo "<form method='POST' action='book.php'><td><input type='submit' value='Book'></td>";
      echo "<input type='hidden' name='dname' value=".$donate['Name'].">";
...
?>
       ...
       <!--<div>
        <a href="login/login.php"><center><p><button type="submit">LOGIN</button></p></center></a>
        <center><h2><font color="white">OR</font></h2></center>
        <center><p><button type="submit">SIGN UP</button></p></center>
       </div>-->
